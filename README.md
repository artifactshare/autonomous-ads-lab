...
- **[journal/](journal/)** — daily work journal, written by humans and automated jobs alike, failures and costs included. One file per entry under `journal/YYYY-MM-DD/` (days before 2026-09-26 are single files); `pnpm journal:show YYYY-MM-DD` prints a whole day
