// CLI: pnpm ads:deploy --creative 8 [--replaces 3] [--apply]
...
const db = openDb()
const r = await deployCreative(db, creative, { apply: process.argv.includes('--apply'), replaces: arg('replaces') ? Number(arg('replaces')) : undefined, log: console.log })
